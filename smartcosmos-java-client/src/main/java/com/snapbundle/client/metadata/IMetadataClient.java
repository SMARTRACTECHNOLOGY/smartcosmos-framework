...
/**
 * Defines, deletes, or queries for {@link com.snapbundle.model.context.IMetadata} instances.
 */
public interface IMetadataClient extends IUpsertableBaseClient<IMetadata>, IDeleteableBaseClient<IMetadata>
{
     ...
     * match using a {@link com.snapbundle.util.json.ViewType#Standard} view.
     *
     ...
     * a {@link com.snapbundle.util.json.ViewType#Standard} view.
     *
     * @param entityReferenceType Entity reference type
     * @param referenceUrn        Reference URN
     ...
     * returned, suitable for inclusion as the {@link com.snapbundle.Field#RAW_VALUE_FIELD} when
     * upserting metadata.
     * <p/>
     ...
     *                         {@link com.snapbundle.model.context.MetadataDataType#XMLType} and
     *                         {@link com.snapbundle.model.context.MetadataDataType#JSONType}
     * @param <T>              Instance that matches the data type defined by the metadataDataType enum
     * @return Encoded representation in JSON of the data provided, accessible via the {@link com.snapbundle.Field#RAW_VALUE_FIELD}
     ...
     * {@link #encodeMetadata(com.snapbundle.model.context.MetadataDataType, Object)} and decodes the value in a
     * type-safe manner.
     *
     * @param metadataDataType Declared data type of the {@link com.snapbundle.Field#RAW_VALUE_FIELD} being submitted
     *                         for decoding
     * @param jsonObject       JSON object that contains the {@link com.snapbundle.Field#RAW_VALUE_FIELD}
