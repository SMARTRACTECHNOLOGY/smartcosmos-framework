...
public interface ITagEndpoints
{
    ...
    final String FIND_ENTITIES_BY_TAGS_ASSIGNED_TO_ENTITY__GET = BASE.concat("?entityReferenceType=%s&referenceUrn=%s&view=%s");

    final String FIND_ENTITIES_BY_TAGS_ASSIGNED_TO_TYPE__GET = BASE.concat("?entityReferenceType=%s&tagName=%s&view=%s");

    final String FIND_ENTITIES_BY_TAGS_NAMED_LIKE__GET = BASE.concat("?tagName=%s&view=%s");
