 ...
 *
 * @see net.smartcosmos.pojo.base.Result#ERR_UNKNOWN_TYPE
 * @see net.smartcosmos.pojo.base.Result#ERR_UNKNOWN_ENTITY
 * @see net.smartcosmos.pojo.base.Result#ERR_FAILURE
 */
public class ServiceException extends Exception
{
    ...
    /**
     * One of the {@link net.smartcosmos.pojo.base.Result} ERR_xxxxx values to indicate why the web service call failed.
     *
