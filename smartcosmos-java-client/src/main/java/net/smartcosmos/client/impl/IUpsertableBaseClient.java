 ...
 * <p>
 * The {@link net.smartcosmos.model.context.IMetadata} entity relies exclusively on the {@link net.smartcosmos.model.base.INamedObject#getName()}
 * field for determining existence.
 ...
 * additional search methods beyond the standard {@link IFindableBaseClient#findByUrn(String)} method, so generally it
 * isn't necessary to explicitly remember the system-generated URN, which is especially true for upsertable entities.
 *
 * @param <T>
 *            One of the upsertable SMART COSMOS contextual entities.
...
public interface IUpsertableBaseClient<T> extends IFindableBaseClient<T>
{
     ...
     * record if no matching system URN already exists. Use this method if you aren't sure what fields changed or if you
     * aren't concerned about network utilization.
     *
     * @param instance
     *            entity instance
     * @return response
