...
-d '{"emailAddress":"you@foo.com", "realm" : "tagdynamics.com"}' \  
...
```
#### Verify Account
curl https://snapbundle.tagdynamics.net/v1/public/registration/confirm/ISSDRGAROMPE/you@foo.com
...
curl https://snapbundle.tagdynamics.net/v1/public/registration/confirm/WNRPQRMDKHBO/them@bar.com
