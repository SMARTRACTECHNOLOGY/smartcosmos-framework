...
public final class OAuthTokenUtil
{
    ...
    public static long calculateBearerTokenExpirationTimestamp(ICosmosContext context,
    ...
    public static long calculateRefreshTokenExpirationTimestamp(ICosmosContext context,
                                                                IOAuthTokenTransaction transaction)
    {
    ...
    public static boolean isBearerTokenExpired(ICosmosContext context, IOAuthTokenTransaction transaction)
    {
        return (System.currentTimeMillis() > calculateBearerTokenExpirationTimestamp(context, transaction));
    }

    public static boolean isRefreshTokenExpired(ICosmosContext context, IOAuthTokenTransaction transaction)
    {
