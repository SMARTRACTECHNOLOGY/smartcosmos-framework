...
{
    String GROUP_REALM_ADMINS = "%s Admins";

    String GROUP_REALM_USERS = "%s Users";
    ...
    void setDirectoryHref(String href);

    String getAdminGroupHref();

    void setAdminGroupHref(String href);

    String getUserGroupHref();

    void setUserGroupHref(String href);
}
