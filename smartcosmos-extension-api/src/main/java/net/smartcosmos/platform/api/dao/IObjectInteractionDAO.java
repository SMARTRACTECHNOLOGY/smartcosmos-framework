...
public interface IObjectInteractionDAO extends IBaseDAO<IObjectInteraction>
{
    ...
    Collection<IObjectInteraction> findByObjectUrn(String objectUrn, IAccount account);

    Collection<IObjectInteraction> findAllAfter(long deviceTimestampStart, IAccount account);

    Collection<IObjectInteraction> findByRange(long deviceTimestampStart, long deviceTimestampEnd, IAccount account);
}
