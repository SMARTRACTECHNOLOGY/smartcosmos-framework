...
== Getting Started
Once you have become a SMART COSMOS Certified and gained access to the SMART COSMOS Objects Developer Kit you need to get your server up and running.  This section helps with some basic commands to get you started.
...
* Java Docs for the SMART COSMOS Extension API -- these Java Docs are also available online at  https://api.smartcosmos.net
...
the SMART COSMOS Server so that it can also detect your jar file.
